...
public enum TossPaymentError {
    ...
    EXCEED_MAX_AUTH_COUNT(403, "최대 인증 횟수를 초과했습니다."),
    ...
    public static TossPaymentError get(String code) {
        TossPaymentError[] values = values();
        for (TossPaymentError value : values) {
